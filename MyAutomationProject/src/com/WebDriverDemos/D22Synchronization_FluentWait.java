...
public class D22Synchronization_FluentWait {
	...
	public static void main(String[] args) {
		...
		.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div[2]/div/div[2]/div/div/div[1]/div[1]/div[1]/div[2]/div[3]/div/div/input"))).sendKeys("Kolh");
		
		//driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div[2]/div/div/div[1]/div[1]/div[1]/div[2]/div[3]/div/div/input")).sendKeys("Kolh");
		driver.findElement(By.xpath("//*[@id=\"root\"]/div[2]/div/div[2]/div/div/div[1]/div[1]/div[1]/div[2]/div[4]/div[1]/div[1]/div/div/div")).click();
		
		//To
		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div[2]/div/div/div[1]/div[2]/div[2]/div[3]/div/div/input")).sendKeys("Pun");
		...
		//Result
		System.out.println(driver.findElement(By.xpath("//*[@id=\"13872668\"]/div[2]/div[3]/div/div[1]/div[1]")).getText());
